...
import mysop.test.harness.ProjMayhamPod;
...
public class PodCreatorTests {
	...
	public void testPodCreation() {
		...
		//Add all of the Accumulo ports to the Accmulo Container:
		...
		Pod myPod = new ProjMayhamPod(apiVersion,podMetadata, podSpec, new PodStatus());
